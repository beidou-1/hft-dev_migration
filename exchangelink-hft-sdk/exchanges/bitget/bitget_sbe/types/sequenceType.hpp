...
class sequenceType
    : public ::sbepp::detail::required_base<::std::uint64_t, sequenceType>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint64_t, sequenceType>::required_base;
...
template<>
class type_traits<::bitget_sbe::schema::types::sequenceType>
{
public:
...
template<>
struct traits_tag<::bitget_sbe::types::sequenceType>
{
    using type = ::bitget_sbe::schema::types::sequenceType;
};

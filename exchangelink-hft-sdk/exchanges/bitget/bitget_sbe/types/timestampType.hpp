...
class timestampType
    : public ::sbepp::detail::required_base<::std::uint64_t, timestampType>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint64_t, timestampType>::required_base;
...
template<>
class type_traits<::bitget_sbe::schema::types::timestampType>
{
public:
...
template<>
struct traits_tag<::bitget_sbe::types::timestampType>
{
    using type = ::bitget_sbe::schema::types::timestampType;
};

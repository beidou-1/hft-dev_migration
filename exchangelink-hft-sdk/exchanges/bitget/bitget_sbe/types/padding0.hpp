...
using padding0 = ::sbepp::detail::static_array_ref<
    Byte, ::std::uint8_t, 0, ::bitget_sbe::schema::types::padding0>;
...
template<>
class type_traits<::bitget_sbe::schema::types::padding0>
{
public:
    ...
    template<typename Byte>
    using value_type = ::bitget_sbe::types::padding0<Byte>;
};

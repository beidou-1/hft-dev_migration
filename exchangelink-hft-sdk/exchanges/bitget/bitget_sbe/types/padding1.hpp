...
class padding1
    : public ::sbepp::detail::required_base<::std::uint8_t, padding1>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint8_t, padding1>::required_base;
...
template<>
class type_traits<::bitget_sbe::schema::types::padding1>
{
public:
    ...
    {
        return "1 byte padding for alignment";
    }
    ...
    using value_type = ::bitget_sbe::types::padding1;
};

template<>
struct traits_tag<::bitget_sbe::types::padding1>
{
    using type = ::bitget_sbe::schema::types::padding1;
};

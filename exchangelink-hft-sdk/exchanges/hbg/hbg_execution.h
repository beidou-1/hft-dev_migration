...
namespace infra {
class HbgExecution : public IExchangeExecution, public WssHandler {
public:
    HbgExecution(net::io_context& ioc, ssl::context& ssl_ctx, const AccountSecret& sec, APIConfig config)
...
private:
    ...
    using WebSocketClient = WssClient<HbgExecution>;

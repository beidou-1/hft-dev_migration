...
|----------|--------|--------|--------|-----|-----|-----|-----|-----|-----|
| BookTicker | 70 | 732 | 318.3 | 327 | 400 | 400 | 401 | 460 | 1 |
...
|----------|--------|--------|--------|
| REST下单响应 | 543 | 652 | 580.4 | 


**测试结果**: REST下单各阶段延迟
| 指标 | 最小值(ms) | 最大值(ms) | 平均值(ms)
|----------|--------|--------|--------|
| 系统发送到交易所创建订单 | 532 | 579 | 564.1 | 
| 交易所创建订单到更新状态 | 8 | 14 | 10.8 | 
| 交易所更新状态到系统接收 | 7 | 75 | 19.8 | 
